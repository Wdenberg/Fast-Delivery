...
export const ButtonQt = ({ color, count, onUpdateCount, min, max, small }: Props) => {
  ...
  const handleRemove = () => { if (canRemove) onUpdateCount(count - 1); }
  const handleAdd = () => { if (canAdd) onUpdateCount(count + 1); }
  return (
